...
/* { dg-final { scan-tree-dump-times "loop vectorized" 1 "vect" { target { vect_element_align && { { ! amdgcn-*-* } && { ! riscv_v } } } } } } */
/* { dg-final { scan-tree-dump-times "loop vectorized" 2 "vect" { target { amdgcn-*-* || riscv_v } } } } */
